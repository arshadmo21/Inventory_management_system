...
public class Statistics extends JFrame{
	...
	try {
            conn con =  new conn();
            String sql = "select * from issueitem";
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(47, 79, 79), 2, true), "Issue-Item-Details",
	...
	ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("inventory/management/system/icons/tenth.png"));
	...
	panel_1.setBorder(new TitledBorder(new LineBorder(new Color(0, 204, 153), 2, true), "Return-Item-Details",
