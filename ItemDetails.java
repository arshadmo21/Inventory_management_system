...
public class ItemDetails extends JFrame implements ActionListener{
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 128, 128), 3, true), "Item-Details",
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                ...
                String sql = "select * from item where concat(name, item_id) like ?";
		PreparedStatement st = con.c.prepareStatement(sql);
		...
		table.setModel(DbUtils.resultSetToTableModel(rs));
            ...
            if(ae.getSource() == b2){
                String sql = "delete from item where name = '" + search.getText() + "'";
		PreparedStatement st = con.c.prepareStatement(sql);
