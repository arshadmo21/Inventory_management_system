...
public class CustomerDetails extends JFrame implements ActionListener{
	...
	ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("inventory/management/system/icons/eight.png"));
	...
	ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("inventory/management/system/icons/nineth.png"));
	...
	ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("inventory/management/system/icons/tenth.png"));
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(95, 158, 160), 3, true), "Customer-Deatails",
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            conn con = new conn();
            if( ae.getSource() == b1){
                String sql = "select * from customer where concat(name, customer_id) like ?";
		PreparedStatement st = con.c.prepareStatement(sql);
		...
		st.close();
            ...
            if(ae.getSource() == b2){
                String sql = "delete from customer where name = '" + search.getText() + "'";
		PreparedStatement st = con.c.prepareStatement(sql);
